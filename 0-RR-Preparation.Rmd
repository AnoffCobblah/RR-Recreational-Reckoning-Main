...
*********************************************************************************************************************************************
# Loading Functions
For clarity, I have written out parts of this methodology as function which can be easily reused, and which will not be easily changed. The section below loads the functions from their files.

```{r Functions, eval=FALSE}
source(paste0(getwd(),"/","WordFlagSentences.R"))
source(paste0(getwd(),"/","WordFlagLemmas.R"))
source(paste0(getwd(),"/","WordFlagLS.R"))
```
